...
import stroom.test.AbstractProxyIntegrationTest;
import stroom.util.test.StroomUnitTest;

import javax.inject.Inject;

@RunWith(SpringJUnit4ClassRunner.class)
public class TestHttpProcessor extends AbstractProxyIntegrationTest {
    private static final Logger LOGGER = LoggerFactory.getLogger(TestHttpProcessor.class);
