 ...
 */
class ByteBufferPoolImpl4 implements ByteBufferPool {
...
//
    ...
    @Inject
    ByteBufferPoolImpl4(final ByteBufferPoolConfig config) {
        final Map<Integer, Integer> pooledByteBufferCounts = config.getPooledByteBufferCounts();
