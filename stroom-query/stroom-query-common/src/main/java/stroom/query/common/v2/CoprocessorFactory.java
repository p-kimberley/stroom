...
public class CoprocessorFactory {
    private final RawResultStoreDbFactory rawResultStoreDbFactory;

    @Inject
    public CoprocessorFactory(final RawResultStoreDbFactory rawResultStoreDbFactory) {
        this.rawResultStoreDbFactory = rawResultStoreDbFactory;
    }

    public Coprocessor create(final CoprocessorSettings settings) {
        if (settings instanceof TableCoprocessorSettings) {
            final TableCoprocessorSettings tableCoprocessorSettings = (TableCoprocessorSettings) settings;
            return new TableCoprocessor(tableCoprocessorSettings, rawResultStoreDbFactory);
