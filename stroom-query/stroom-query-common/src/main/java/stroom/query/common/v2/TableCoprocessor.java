...
//        this.maxGroupDepth = compiledDepths.getMaxGroupDepth();
    ...
    public TableCoprocessor(final LinkedBlockingQueue<Item> queue, final CompiledFields compiledFields, final CompiledDepths compiledDepths) {
        this.key = null;
        this.queue = queue;
