...
public class ItemSerde extends AbstractKryoSerde<Item> {
    @Override
    public Item read(final Input input) {
        return kryoContextResult(kryo -> kryo.readObject(input, Item.class));
    }

    @Override
    public void write(final Output output, final Item object) {
